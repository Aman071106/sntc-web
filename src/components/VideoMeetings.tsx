...
// import { Video, Users, Lock, Eye, EyeOff, Crown, User, Settings, Clock } from 'lucide-react';
...
//   useEffect(() => {
//     fetchMeetings();import { useState, useEffect } from 'react';
//     import { Card } from '@/components/ui/card';
//     import { Button } from '@/components/ui/button';
//     import { Input } from '@/components/ui/input';
//     import { Label } from '@/components/ui/label';
...
//     // Set up interval to refresh meetings list every 30 seconds
//     const interval = setInterval(fetchMeetings, 30000);
//     return () => clearInterval(interval);
//   }, []);
...
//         if (userInfo.data.email === 'aman07112006@gmail.com') {
//           await handleCreateMeeting();
//         } else {
//           alert('Only Tech Secretary can host meetings');
//         }
//       } catch (error) {
...
//           }}
//         >
//           {/* Your custom video conferencing UI or use default */}
//         </LiveKitRoom>
//       </div>
//     );
//   }
